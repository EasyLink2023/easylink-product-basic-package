                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-primary">
                            ...
                            <form id="menuForm" method="POST" action="{{ route('admin.blog.update') }}"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="meta_keyword" class="form-control" id="meta_keyword" value="{{ $blog->meta_keyword }}"
                                            placeholder="Enter Meta Keyword">
                                    </div>
                                    <div class="form-group">
                                        <img src="{{ asset('asset/blogs') . '/' . $blog->cover_image }}"
                                        alt="{{ $blog->cover_image }}" class="img-fluid" style="width:150px"
                                        onerror="this.src='{{ asset('frontend/default-images/default-image-1920x560.jpg') }}'" /> <br> <hr>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea id="summernote" name="content" class="form-control" value="{{ $blog->content }}">{{ $blog->content }}</textarea>
                                    </div>
                                    <div class="form-group">
                                        <label for="created_by">Created By</label>
                                        <input type="text" name="created_by" class="form-control" id="created_by" value="{{ $blog->created_by }}"
                                            value="Admin" placeholder="Enter created by">
                                    </div>
                                </div>
                        </div>
                        <div class="card-footer">
                            <input type="hidden" name="id" class="form-control" id="title" value="{{ $blog->id }}"
                            placeholder="Enter Title">
