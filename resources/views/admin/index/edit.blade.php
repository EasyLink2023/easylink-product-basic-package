    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Edit Index Page Data</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Home</a></li>
                            <li class="breadcrumb-item active">Edit Index Page Data</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-12">
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Edit Index Page Data</h3>
                            </div>
                            <form id="settingForm" method="POST" action="{{ route('admin.index.page.update') }}"
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="key_name" class="form-control" id="key_name"
                                            ...
                                            value="{{ isset($indexPage) ? $indexPage->key : '' }}" readonly>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        @elseif($indexPage->value_type == '3')
                                            <div class="form-group" id="select-value">
                                                <label for="value">Select Value</label>
                                                <select name="value" id="value" class="form-control">
                                                    <option value="0" {{ $indexPage->value == '0' ? 'selected' : '' }}>Hide</option>
                                                    <option value="1" {{ $indexPage->value == '1' ? 'selected' : '' }}>Show</option>
                                                </select>
                                            </div>
                                        @else
                                            ...
                                            <input type="text" name="value" class="form-control" id="value"
                                                placeholder="Enter value Name"
                                                value="{{ isset($indexPage) ? $indexPage->value : '' }}">
                                        @endif
                                    </div>
                                </div>
                        </div>
                        <div class="card-footer">
                            <input type="hidden" name="id" value="{{ isset($indexPage) ? $indexPage->id : '' }}"">
